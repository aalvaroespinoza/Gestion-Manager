    ...
    >
      ...
      <div className="grid grid-cols-12 gap-4 sm:gap-6">
        ...
        <SpotlightCard className="col-span-12 lg:col-span-4 flex flex-col justify-between">
          <div>
            ...
            <div className="mt-4">
              ...
              <div className="flex items-center gap-2 text-[11px] text-muted-foreground mt-1">
                <span>Fondo apertura: <strong className="font-mono text-foreground">$80.000</strong></span>
                <span>•</span>
                <span>Cobrado: <strong className="font-mono text-emerald-500">+$145.890</strong></span>
              </div>
            </div>
          ...
          {/* Action Link */}
          <Link href="/ventas" className="mt-5 block">
            <Button
              variant="outline"
              size="sm"
